...
<body style="background:#E3E3E3;margin-top:5.5%">


<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-primary">
@foreach($user as $user2)
    <h1 style="font-family:serif;text-decoration:underline double white;color:black">ProFile oF {{$user2->name}}</h1>
@endforeach
    ...
    <div class="container border border-light" style="border-bottom:1px;display:block;width:60%;margin-left:20%;border-bottom-right-radius:5px;border-bottom-left-radius:5px;background:white">
        <div class="row">
            <div class="col-md-3 p-0 " style="background:white">

            @foreach($user as $user)
@if(!$user->propicture == null)
                <img class="col-sm-12 p-0" id="preview" src='{{asset("images/profile/".$user->propicture)}}' style="width:25rem;height:15rem"  alt="...">
@else                 <img class="col-sm-12 p-0" id="preview" src='{{asset("images/profile/1234567.jpg")}}' style="width:25rem;height:15rem" alt="...">

@endif
            </div>
            <div class="col-md-8" style="height:50%;font-family:serif">
                <h3 style="display:inline-block">{{$user->name}}</h6>
                    <br>
